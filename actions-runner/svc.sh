...
SVC_NAME="actions.runner.okuspocus-vault-action-exampleapp.Daniels-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (okuspocus-vault-action-exampleapp.Daniels-MacBook-Pro)"
